        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <Card className="shadow-sm hover:shadow-skoolife-lg transition-all duration-300 group">
              <CardHeader className="pb-3 sm:pb-4">
                <div className="flex items-center mb-2">
                  <Calendar className="h-6 w-6 sm:h-8 sm:w-8 text-primary animate-calendar-flip group-hover:animate-icon-wiggle transition-all duration-200" />
                </div>
            ...
            <Card className="shadow-sm hover:shadow-skoolife-lg transition-all duration-300 group">
              <CardHeader className="pb-3 sm:pb-4">
                <div className="flex items-center mb-2">
                  <CheckSquare className="h-6 w-6 sm:h-8 sm:w-8 text-primary animate-task-check group-hover:animate-icon-wiggle transition-all duration-200" />
                </div>
                <CardTitle className="font-heading text-base sm:text-lg">
                  Tâches
                </CardTitle>
            ...
            <Card className="shadow-sm hover:shadow-skoolife-lg transition-all duration-300 group">
              <CardHeader className="pb-3 sm:pb-4">
                <div className="flex items-center mb-2">
                  <CreditCard className="h-6 w-6 sm:h-8 sm:w-8 text-primary animate-payment-swipe group-hover:animate-icon-wiggle transition-all duration-200" />
                </div>
                <CardTitle className="font-heading text-base sm:text-lg">
                  Finances étudiantes
                </CardTitle>
            ...
            <Card className="shadow-sm hover:shadow-skoolife-lg transition-all duration-300 group">
              <CardHeader className="pb-3 sm:pb-4">
                <div className="flex items-center mb-2">
                  <FileText className="h-6 w-6 sm:h-8 sm:w-8 text-primary animate-document-organize group-hover:animate-icon-wiggle transition-all duration-200" />
                </div>
                <CardTitle className="font-heading text-base sm:text-lg">
                  Documents
                </CardTitle>
