...
export const SkoolifeLandingFR = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <section id="inscription" className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="container max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-heading text-foreground mb-3 sm:mb-4">
      ...
      <div className="flex justify-center py-1">
        <div className="animate-bounce">
          <ArrowDown className="h-5 w-5 text-skoolife-yellow" style={{ color: 'hsl(var(--skoolife-yellow))' }} />
        </div>
      </div>

      {/* Section FAQ */}
      <section id="faq" className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 bg-muted/30 relative">
